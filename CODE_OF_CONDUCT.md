...
1. Reports will be initially assessed by the project maintainers or an appointed conduct committee.
2. The project team will evaluate the credibility and severity of the report and may request additional information from reporters or witnesses.
3. If an allegation is substantiated, the project team will determine appropriate corrective actions, which may include private warnings, removal of access to project resources, or removal from the project team.
4. The project team will attempt to protect the privacy and safety of all parties involved while balancing the need for transparency for the broader community when appropriate.
